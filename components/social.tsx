...
export function Social() {
  return (
    <div className="flex gap-3 desktop:hidden laptop:hidden mini:py-2 tablet:hidden mobile:justify-between mobile:w-full mobile:px-16 mini:px-14 items-center">
      <Link
        href={'https://wa.me/75998141403'}
        className="flex gap-2 bg-white hover:bg-opacity-95 transition-colors duration-300 bg-opacity-80 p-3 mini:p-2 rounded-xl items-center"
      >
        <FaWhatsapp size={22} className="text-[#74C992]" />
      </Link>
      <Link
        href={'https://www.instagram.com/kcleiloes/'}
        className="flex gap-2 bg-white hover:bg-opacity-95 transition-colors duration-300 bg-opacity-80 p-2 mini:p-1 rounded-xl items-center"
      >
