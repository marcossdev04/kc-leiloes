...
export function Tutorial() {
  ...
  return (
    <div className="w-[1600px] h-full mt-40 mb-20 mini:px-3 mobile:mb-10 mini:mb-10 mini:mt-10 mobile:mt-10 laptop:w-[1200px] mobile:w-full mini:w-full items-center mx-auto flex">
      ...
      <div className="absolute inset-y-0 mobile:top-[370px] mobile:h-[190px] mini:hidden mobile:rounded-none mobile:-right-[100px] mobile:w-[270px] blur-md mobile:blur-sm  z-50 laptop:w-[800px] laptop:h-[350px] laptop:top-[800px]  bg-[#0F0F0F] top-[1050px] laptop:right-[30px]  rounded-full  h-[500px] right-[90px] w-[800px]"></div>
