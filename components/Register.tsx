...
export function Register() {
  return (
    <div className="flex w-full max-w-[1400px] laptop:max-w-[1200px] mobile:w-full mx-auto mobile:mt-16 -mt-36">
      <div className="flex flex-col w-full gap-10">
        <div className="text-4xl text-[#dbc994] mobile:text-center">
          Faça seu cadastro
        </div>
