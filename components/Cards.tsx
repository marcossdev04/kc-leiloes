  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col w-full gap-5">
        ...
        <div className="w-[1600px] py-10 laptop:w-[1200px] mobile:w-[80%] mx-auto">
          <div className="flex justify-around w-full">
            <Card className="bg-zinc-800 shadow-[#dbc994] shadow-lg">
              <CardContent>
                <Image
                  className="w-[500px] border-4 border-[#dbc994] h-[400px] rounded-lg mt-5"
                  alt="img"
                  src={teste}
                />
                <div className=" mt-5 flex flex-col gap-5">
                  ...
                  <div className="text-[#dbc994] flex items-center gap-3 text-2xl">
                    <div>
                  ...
                  <div className="w-full mt-5 transition-colors duration-300 cursor-pointer      hover:bg-opacity-90 text-black font-medium text-xl py-1 bg-[#dbc994] rounded-lg px-5 flex justify-center  items-center">
                  ...
                  <div className="text-white mb-2 bg-zinc-500 py-1 rounded-lg bg-opacity-50 flex flex-col justify-center items-center ">
                    ...
                    <div>
                      <div className="text-[#dbc994] text-3xl font-semibold">
                        R$ 8.750,00
                      </div>
                    </div>
                  </div>
