...
export function More() {
  const sections = ['video', 'passo-a-passo', 'tutorial', 'form', 'faq']
  ...
  return (
    <button
      ...
      className="fixed bottom-0 left-1/2 mobile:hidden mini:hidden transform z-50 -translate-x-1/2 text-[#dbc994] pt-2 w-full max-w-[200px] flex justify-center rounded-full"
    >
