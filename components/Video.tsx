    ...
    <div className="py-20 bg-white/5">
      <div className="max-w-[1600px] mx-auto flex flex-col-reverse lg:flex-row items-center gap-16 px-6">
        <div className="w-full lg:w-1/2 flex flex-col gap-8 p-6 text-justify">
          <div>
            <h2 className="text-3xl font-light text-[#dbc994] mb-2">Simplifique sua jornada em leilões</h2>
          ...
          <div className="space-y-8 text-zinc-200">
            <div className="flex items-start gap-6 hover:translate-x-2 transition-transform duration-300">
              <div className="shrink-0 mt-1 p-2.5 bg-[#dbc994]/5 rounded-lg border border-[#dbc994]/10">
                <svg className="w-5 h-5 text-[#dbc994]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <div className="flex-1">
                <h3 className="font-medium mb-3 text-[#dbc994]">Transparência e Segurança</h3>
                <p className="text-sm text-zinc-400 leading-relaxed">Tenha acesso a informações detalhadas e documentação completa de cada lote, permitindo análises aprofundadas e decisões mais seguras em suas participações.</p>
              </div>
            </div>
            <div className="flex items-start gap-6 hover:translate-x-2 transition-transform duration-300">
              <div className="shrink-0 mt-1 p-2.5 bg-[#dbc994]/5 rounded-lg border border-[#dbc994]/10">
              ...
              <div className="flex-1">
                <h3 className="font-medium mb-3 text-[#dbc994]">Oportunidades Exclusivas</h3>
                <p className="text-sm text-zinc-400 leading-relaxed">Explore uma seleção cuidadosamente curada de bens com valores diferenciados e condições especiais de pagamento, maximizando seu potencial de investimento.</p>
              </div>
            </div>
            <div className="flex items-start gap-6 hover:translate-x-2 transition-transform duration-300">
              <div className="shrink-0 mt-1 p-2.5 bg-[#dbc994]/5 rounded-lg border border-[#dbc994]/10">
              ...
              <div className="flex-1">
                <h3 className="font-medium mb-3 text-[#dbc994]">Suporte Especializado</h3>
                <p className="text-sm text-zinc-400 leading-relaxed">Conte com orientação profissional personalizada em todas as etapas do processo, desde a análise inicial até a conclusão bem-sucedida da sua aquisição.</p>
              </div>
            </div>
          </div>
        </div>
