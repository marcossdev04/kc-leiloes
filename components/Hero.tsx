export function Hero() {
  return (
    <div className="max-w-[1400px] desktop:mx-auto laptop:mx-auto laptop:max-w-[1200px] mobile:w-full -mt-10 h-[100vh] flex mobile:flex-col mobile:h-full mobile:mt-5 justify-center items-center">
